...
# filename_calib = f"Raw Data\LH data\calib\pydotbot.log"
# filename_data  = f"Raw Data/LH data/exp_data/pydotbot.log"
filename = f"test_2/pydotbot.log"
...
df.to_csv("./outlier_test_2.csv",index=True)
...
df.to_csv("test_2/lh_test_2_data.csv",index=True)