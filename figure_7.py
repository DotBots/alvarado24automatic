...
from functions.plotting import plot_trajectory_and_error, plot_error_histogram
...
LH_data_file = f'./dataset/lighthouse/LH_data_scene_{experiment_number}.csv'
mocap_data_file = f'./dataset/ground_truth/mocap_data_scene_{experiment_number}.csv'  
